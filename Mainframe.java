...
public class Mainframe extends JFrame{
	...
	NewLabel.setIcon(new ImageIcon(ClassLoader.getSystemResource("airline/management/system/icon/front3.jpg")));
	NewLabel.setBounds(0, 0, 1800, 960); 
	add(NewLabel);
        
        JLabel AirlineManagementSystem = new JLabel("AIR INDIA WELCOMES YOU");
	AirlineManagementSystem.setForeground(Color.BLUE);
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.BOLD, 50));
	AirlineManagementSystem.setBounds(300, 60, 1000, 55);
