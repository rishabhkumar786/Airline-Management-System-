...
public class Journey_Details extends JFrame{  //Forth
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    String str = "select reservation.pnr_no,reservation.ticket_id,jrnydetails.f_code,jrnydetails.jny_date,jrnydetails.jny_time,jrnydetails.src,jrnydetails.dst FROM reservation INNER JOIN jrnydetails ON jrnydetails.f_code = reservation.f_code where src = '"+src+"' and dst = '"+dst+"'";
                    //String str = "select src,dst,jny_date, jny_time, f_code, pnr_no, ticket_id from jrnydetails ,reservation where src = '"+src+"' and dst = '"+dst+"'";
